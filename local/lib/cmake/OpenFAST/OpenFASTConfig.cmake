...
set(OpenFAST_CXX_COMPILER "/opt/anaconda3/envs/weis-env/bin/x86_64-apple-darwin13.4.0-clang++")
set(OpenFAST_C_COMPILER "/opt/anaconda3/envs/weis-env/bin/x86_64-apple-darwin13.4.0-clang")
set(OpenFAST_Fortran_COMPILER "/opt/anaconda3/envs/weis-env/bin/x86_64-apple-darwin13.4.0-gfortran")

# Compiler flags used by OpenFAST build
set(OpenFAST_CXX_COMPILER_FLAGS "-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -stdlib=libc++ -fvisibility-inlines-hidden -fmessage-length=0 -isystem /opt/anaconda3/envs/weis-env/include -fpic")
set(OpenFAST_C_COMPILER_FLAGS "-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /opt/anaconda3/envs/weis-env/include")
set(OpenFAST_Fortran_COMPILER_FLAGS "-march=core2 -mtune=haswell -ftree-vectorize -fPIC -fstack-protector -O2 -pipe -isystem /opt/anaconda3/envs/weis-env/include -fpic  -ffree-line-length-none -cpp -fstack-reuse=none")
